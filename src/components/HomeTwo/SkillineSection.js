          ...
          <div className="row">
            <div className="col-xxl-6 offset-xxl-3 col-xl-6 offset-xl-3 col-lg-8 offset-lg-2">
              <div className="section__title-wrapper mb-60 text-center">
                ...
                <p>
                  Sloshed faff about me old mucker blatant bubble and squeak
                  hanky panky some dodgy chav bevvy arse chimney pot I, ruddy
                  plastered buggered smashing blow off I'm telling up the kyver
                  he legged it bleeder jolly good,{' '}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="col-xxl-5 offset-xl-1 col-xl-5 offset-xl-1 col-lg-6">
              <div className="what__item transition-3 mb-30 p-relative fix">
                ...
                <div className="what__content p-absolute text-center">
                  ...
                  <Link href="/contact">
                    <a className="e-btn e-btn-border-2">Start a class today</a>
                  </Link>
                </div>
              </div>
            </div>
            <div className="col-xxl-5 col-xl-5 col-lg-6">
              <div className="what__item transition-3 mb-30 p-relative fix">
                ...
                <div className="what__content p-absolute text-center">
                  ...
                  <Link href="/contact">
                    <a className="e-btn e-btn-border-2">Start teaching</a>
                  </Link>
                </div>
              </div>
            </div>
